...
export default function convertToValidationMarker(validationResult: true | true[] | string | string[] | ValidationError | ValidationError[] | ValidationErrorLike | ValidationErrorLike[], level: 'error' | 'warning' | undefined, context: ValidationContext): ValidationMarker[];
export {};
