...
var genericValidators = {
  ...
  all: function () {
    var _all = _asyncToGenerator(function* (children, value, message) {
      var resolved = yield Promise.all(children.map(child => child.validate(value)));
  ...
  either: function () {
    var _either = _asyncToGenerator(function* (children, value, message) {
      var resolved = yield Promise.all(children.map(child => child.validate(value)));
  ...
  custom: function () {
    ...
    function custom(_x7, _x8, _x9, _x10) {
